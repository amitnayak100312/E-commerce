        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div class="product-image-container mb-3">
                    <img id="mainImage" src="{{ asset('products/' . $product->product_image) }}" class="main-image"
                        alt="{{ $product->product_title }}">
                </div>

                <div class="thumbnail-container">
                    <img onclick="changeImage(this)" src="{{ asset('products/' . $product->product_image) }}"
                ...
                <form action="#" method="POST">
                    ...
                    <div class="row align-items-end mb-4">
                        <div class="col">
                            ...
                            <a href="{{ route('stripe',$product->product_price) }}" type="submit" class="btn btn-outline-primary btn-mid">
